...
export default {
  ...
  methods: {
    initCharts () {
      ...
      this.setTypePieOption(defaultData.typePieData)
      ...
      this.setStoreBarOption(defaultData.nameData, defaultData.lineData)
      ...
      this.setBeijingScatterOption(defaultData.beijingData)
    },
    ...
    setStoreBarOption (nameData, lineData) {
